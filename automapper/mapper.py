...
class MappingWrapper(Generic[T]):
    ...
    def map(
        ...
        *,
        ...
        skip_circular_references: bool = True,
        ...
        Args:
            ...
            skip_circular_references (bool, optional): Skip circular references when creating `target class` obj. Defaults to False.
        ...
        return self.__mapper._map_common(
            ...
            skip_circular_references=skip_circular_references,
...
class Mapper:
    ...
    def _map_subobject(
        self, obj: S, _visited_stack: Set[int], skip_none_values: bool = False, skip_circular_references: bool = True, custom_mapping: FieldsMap = None
    ) -> Any:
        ...
        if type(obj) in self._mappings:
            ...
            result: Any = self._map_common(
                obj, target_cls, _visited_stack, skip_none_values=skip_none_values, skip_circular_references=skip_circular_references, custom_mapping=custom_mapping
            )
        else:
                ...
                if isinstance(obj, dict):
                    result = {
                        k: self._map_subobject(
                            v, _visited_stack, skip_none_values=skip_none_values, skip_circular_references=skip_circular_references, custom_mapping=custom_mapping
                        )
                    ...
                    result = type(obj)(  # type: ignore [call-arg]
                        [
                            self._map_subobject(
                                x, _visited_stack, skip_none_values=skip_none_values, skip_circular_references=skip_circular_references, custom_mapping=custom_mapping
                            )
            ...
            if value is not None:
                if use_deepcopy:
                    mapped_values[field_name] = self._map_subobject(
                        value, _visited_stack, skip_none_values, skip_circular_references, custom_mapping
                    )
